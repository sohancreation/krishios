...
import { Plus, Camera, Mic, Wallet, BarChart3, Fish } from 'lucide-react';
...
export function QuickActions() {
  ...
  const promptSignup = () => {
    toast.info(language === 'bn' ? 'এই ফিচার ব্যবহার করতে সাইন আপ করুন' : 'Please sign up to use this feature');
    routerNavigate('/auth');
  };
  ...
  const actions: QuickAction[] = [
    ...
    },
    {
      ...
      action: () => requireAuth(() => navigateTo('ai', { mode: 'camera' })),
    },
    {
      id: '5',
      emoji: '🎙️',
      ...
      action: () => requireAuth(() => navigateTo('ai', { mode: 'voice' })),
    },
    {
      id: '6',
      emoji: '💰',
      ...
      action: () => requireAuth(() => navigateTo('finance')),
    },
    {
      id: '7',
      emoji: '📊',
      ...
      action: () => requireAuth(() => navigateTo('production')),
    },
  ];
